...
class _$_Books implements _Books {
  const _$_Books({this.kind, this.totalItems, final List<Items>? items})
      : _items = items;
  ...
  @override
  String toString() {
    return 'Books(kind: $kind, totalItems: $totalItems, items: $items)';
  }
...
abstract class _Books implements Books {
  const factory _Books(
      {final String? kind,
      final int? totalItems,
      final List<Items>? items}) = _$_Books;
...
class _$_VolumeInfo implements _VolumeInfo {
  ...
  @override
  String toString() {
    return 'VolumeInfo(title: $title, subtitle: $subtitle, authors: $authors, publisher: $publisher, publishedDate: $publishedDate, description: $description, pageCount: $pageCount, printType: $printType, categories: $categories, maturityRating: $maturityRating, imageLinks: $imageLinks, language: $language, previewLink: $previewLink, infoLink: $infoLink)';
  }
...
abstract class _VolumeInfo implements VolumeInfo {
  const factory _VolumeInfo(
      ...
      final String? language,
      final String? previewLink,
      final String? infoLink}) = _$_VolumeInfo;
